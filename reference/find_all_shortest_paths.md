...
- source_species_id:
  ...
  species ID of the upstream/source vertex

- dest_species_id:

  species ID of the downstream/destination vertex

- weight_var:

  variable in edges to use for edge weights

## Value

All the shortest paths between \`source_species_id\` and
\`dest_species_id\`
